  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 gap-8 bg-background text-foreground">
      <main className="flex flex-col items-center gap-6">
        ...
        <button className="rounded-full bg-foreground text-background px-8 py-3 text-lg font-semibold shadow hover:bg-[#383838] dark:hover:bg-[#ccc] transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-foreground">
          Summarise a Blog
        </button>
      </main>
    </div>
